...
import com.connect.brick.repository.data.custom.ApartmentIchRepositoryCustom;

import kr.co.shineware.nlp.komoran.model.Token;

public class ApartmentIchRepositoryImpl implements ApartmentIchRepositoryCustom {
...
//    private SearchComponent searchComponent;
	...
	public List<ApartmentIch> findBySearch(List<Token> tokenList, List<String> morphMustList, String org) {
		...
		SearchComponent searchComponent = new SearchComponent("TB_APARTMENT_V2_ICH", null);
		...
		return entityManager.createNativeQuery(query, ApartmentIch.class)
		        .getResultList();
	}
